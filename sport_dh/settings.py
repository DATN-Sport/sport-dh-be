"""
Django settings for sport_dh project.
...
SECRET_KEY = 'django-insecure-jsea)#-vi6g9)xnpko7zjr@j2gd+x&o895-t*dh)g97%45k)(_'
...
WSGI_APPLICATION = 'sport_dh.wsgi.application'
...
LOGGING = {
    ...
    'loggers': {
        ...
        # Tắt debug logging của OpenAI client để tránh lỗi encoding với ký tự tiếng Việt
        'openai': {
            'level': 'WARNING',
        },
        'httpcore': {
